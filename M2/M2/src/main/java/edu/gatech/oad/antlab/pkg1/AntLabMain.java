 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Colby Tobin");
		  toPrint += p1.toString("ctobin30");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Kar Shin Lin");
		  toPrint += p2.toString("klin83");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Angel Seay");
		  toPrint += p3.toString("aseay6");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Maxwell Engle");
                  toPrint += p4.toString("mengle7");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Ally Liu");
                  toPrint += p5.toString("sliu402");
     ...
     * @param args arguments made through the command line for the program
     */
